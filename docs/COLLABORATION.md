...
| 5 | 음성 인식 Android 실기 검증 | 모듈은 **sherpa-onnx v1.13.6으로 확정·임포트 완료**(2026-08-27). PC 검증 완료, Android는 NDK 미설치로 빌드하지 못했다. `docs/Core/specs/SHERPA_ONNX_INTEGRATION.md` 6절 참조 |
