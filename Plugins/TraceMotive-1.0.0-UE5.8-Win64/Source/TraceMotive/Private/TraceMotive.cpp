...
void FTraceMotiveModule::RegisterMenus()
{
    ...
    // Keep all public tools reachable from Window/Tools and register their tab spawners
    // during module startup. Feature-specific registration remains in each feature.
