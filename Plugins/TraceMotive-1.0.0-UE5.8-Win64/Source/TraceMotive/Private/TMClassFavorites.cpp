...

{
...

    {
        ...
        return ResolveActorClassFromAssetData(AssetData) != nullptr || IsLevelAsset(AssetData);
...

    {
...

        {
            ...
            UE_LOG(LogTraceMotive, Warning, TEXT("Class Favorites: %s is not a supported Actor class or Level asset."),
...

    {
        ...
        if (!ActorClass || !EditorWorld || EditorWorld->IsPlayInEditor())
        ...
        AActor* SpawnedActor = GEditor->AddActor(EditorWorld->GetCurrentLevel(), ActorClass, SpawnTransform, false, RF_Transactional, true);
            ...
            return SNew(SBorder)
                ...
                [
                    ...
                    [
                        ...
                        .ToolTipText(TMLoc::Text(TEXT("Place this class at world origin (0,0,0)."), TEXT("이 클래스를 월드 원점(0,0,0)에 배치합니다.")))
                    ...
                    [
                        ...
                        .ToolTipText(TMLoc::Text(TEXT("Place this class at the current level viewport camera location."), TEXT("이 클래스를 현재 레벨 뷰포트 카메라 위치에 배치합니다.")))
                ...
                [
                    ...
                    [
                        ...
                        [
                            ...
                            .Text(TMLoc::Text(TEXT("Class Favorites"), TEXT("클래스 즐겨찾기")))
                    ...
                    [
                        ...
                        .HintText(TMLoc::Text(TEXT("Filter favorite classes"), TEXT("즐겨찾기 클래스 필터")))
...

    {
        ...
        TSharedRef<SDockTab> Tab = SNew(SDockTab)
            ...
            .Label(TMLoc::Text(TEXT("Class Favorites"), TEXT("클래스 즐겨찾기")))
...

    {
        ...
        FGlobalTabmanager::Get()->RegisterNomadTabSpawner(
            ...
            .SetDisplayName(TMLoc::Text(TEXT("Class Favorites"), TEXT("클래스 즐겨찾기")))

            .SetTooltipText(TMLoc::Text(TEXT("Open class favorites for quick viewport placement."), TEXT("뷰포트에 빠르게 배치할 클래스 즐겨찾기 창을 엽니다.")))
...

{
...

    {
...

        {
            ...
            Section.AddMenuEntry(
                ...
                TMLoc::Text(TEXT("Add to Class Favorites"), TEXT("클래스 즐겨찾기에 추가")),

                TMLoc::Text(TEXT("Add selected Actor Blueprint/class assets to the class favorites window."), TEXT("선택한 액터 Blueprint/클래스 에셋을 클래스 즐겨찾기 창에 추가합니다.")),
            ...
            Section.AddMenuEntry(
                ...
                TMLoc::Text(TEXT("Open Class Favorites"), TEXT("클래스 즐겨찾기 열기")),

                TMLoc::Text(TEXT("Open the class favorites window for quick viewport placement."), TEXT("뷰포트에 빠르게 배치할 클래스 즐겨찾기 창을 엽니다.")),
...

        {
            ...
            Section.AddMenuEntry(
                ...
                TMLoc::Text(TEXT("Class Favorites"), TEXT("클래스 즐겨찾기")),

                TMLoc::Text(TEXT("Open the class favorites placement window."), TEXT("클래스 즐겨찾기 배치 창을 엽니다.")),
...

    {
...

        {
            ...
            UE_LOG(LogTraceMotive, Warning, TEXT("Class Favorites: no selected placeable Actor Blueprint/Class assets were added."));
